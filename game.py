...
# Lokesh Sharma 2year CSE student at gits...
...
PIPES_LIST = (
    ...
    'assets/sprites/pipe-red.png',
     'assets/sprites/pipe1.jpg',
      'assets/sprites/pipe2.jpg',
       'assets/sprites/pipe3.jpg',
)
...
def main():
    ...
    IMAGES['numbers'] = (pygame.image.load('assets/sprites/0.jpg').convert_alpha(), pygame.image.load('assets/sprites/1.jpg').convert_alpha(), pygame.image.load('assets/sprites/2.jpg').convert_alpha(), pygame.image.load('assets/sprites/3.jpg').convert_alpha(), pygame.image.load('assets/sprites/4.jpg').convert_alpha(), pygame.image.load('assets/sprites/5.jpg').convert_alpha(), pygame.image.load('assets/sprites/6.jpg').convert_alpha(), pygame.image.load('assets/sprites/7.jpg').convert_alpha(), pygame.image.load('assets/sprites/8.jpg').convert_alpha(), pygame.image.load('assets/sprites/9.jpg').convert_alpha())
